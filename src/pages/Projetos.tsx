...
const projects = [
  ...
  {
    title: "Programa de Educação Ambiental – Ipeúna/SP",
    category: "ambiental" as const,
    local: "Ipeúna, SP",
    year: "2026",
  ...
  },
  {
    ...
    local: "Votuporanga, SP",
    year: "2026",
    description: "Desenvolvimento Cerebral: neurociência aplicada à educação infantil. Evento e workshop promovendo conhecimento sobre desenvolvimento infantil.",
    result: "500 pessoas impactadas",
    link: "https://eventos.sp.senac.br/evento/congresso-senac-votuporanga-para-profissionais-da-educacao",
  },
  {
    title: "Revisão do PMSB – Brotas/SP",
    category: "ambiental" as const,
    local: "Brotas, SP",
    year: "2025",
    description: "Revisão técnica do Plano Municipal de Saneamento Básico (PMSB) do município.",
    result: "23.000 pessoas impactadas",
    link: "https://www.brotas.sp.gov.br/noticias/agricultura/secretarias-se-reunem-para-discutir-revisao-do-plano-de-saneamento",
  },
  {
    title: "Revisão do PMSB – Porto Feliz/SP",
    category: "ambiental" as const,
    local: "Porto Feliz, SP",
    year: "2025",
    description: "Revisão do Plano Municipal de Saneamento Básico (PMSB) do município.",
    result: "56.000 pessoas impactadas",
    link: "https://www.saaeportofeliz.sp.gov.br/noticias/geral/pmsb-plano-municipal-de-saneamento-basico",
  },
  {
    title: "Programa Minha Casa, Minha Vida – Rio Claro/SP",
    category: "social" as const,
    local: "Rio Claro, SP",
    year: "2025",
    description: "Atendimento presencial à população em vulnerabilidade social pelo Programa Minha Casa, Minha Vida.",
    result: "5.000 pessoas impactadas",
    link: "https://drive.google.com/file/d/1PhIQI80YdY-srZawYY22mwxRCfRuP8OT/view?usp=sharing",
  },
  {
    title: "Plano Municipal (PMGIRS) – Jardinópolis/SP",
    category: "ambiental" as const,
    local: "Jardinópolis, SP",
    year: "2024",
    description: "Elaboração do Plano Municipal de Gestão Integrada de Resíduos Sólidos (PMGIRS) para o município.",
    result: "47.000 pessoas impactadas",
    link: "https://www.jardinopolis.sp.gov.br/portal/noticias/0/3/3026/cerimonia-de-entrega-do-plano-municipal-gestao-integrada-de-residuos-solidos",
  },
  {
    title: "Palestra Instituição Privada Escola Paideia – Bebedouro/SP",
    category: "educacional" as const,
    local: "Bebedouro, SP",
    year: "2024",
    description: "Palestra com o tema 'Do digital ao Real equilibrando tecnologia, desenvolvimento cerebral e relações humanas'.",
    result: "100 pessoas impactadas",
    link: "https://gazetadebebedouro.com.br/uso-de-telas-por-criancas-e-tema-de-palestra-promovida-pela-paideia/",
  },
  {
    title: "Programa de Educação Ambiental – Rio Claro/SP",
    category: "ambiental" as const,
    local: "Rio Claro, SP",
    year: "2014",
    description: "Programa de Educação Ambiental direcionado para a população em geral, com elaboração de documento técnico.",
    result: "210.000 pessoas impactadas",
    link: "https://www2.rioclaro.sp.gov.br/pd/arquivos/VolumelLevantamento.pdf",
  },
  {
    title: "Plano Municipal (PMGIRS) – Dracena/SP",
    category: "ambiental" as const,
    local: "Dracena, SP",
    year: "2013",
    description: "Elaboração do Plano Municipal de Gestão Integrada de Resíduos Sólidos (PMGIRS).",
    result: "45.000 pessoas impactadas",
    link: "https://smastr16.blob.core.windows.net/cpla/2017/05/dracena-vol.-1.pdf",
  },
];
